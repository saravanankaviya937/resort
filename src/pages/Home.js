      ...
      <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src={glyn2} className="d-block w-100" alt="Apartment 1" height="500px" />
          </div>
          <div className="carousel-item">
            <img src={glyn6} className="d-block w-100" alt="Apartment 3" height="500px" />
          </div>
          <div className="carousel-item">
            <img src={glyn18} className="d-block w-100" alt="Apartment 2" height="500px" />
          </div>
        </div>
